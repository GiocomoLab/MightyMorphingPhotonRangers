...
for mouse in mice:
        ...
        dirbase = "G:\\My Drive\\Figures\\TwoTower\\PlaceCells\\C_corr\\%s\\" % mouse
        try:
            os.makedirs(dirbase)
        except:
        ...
        for i in range(df_sess.shape[0]):
            try:
                ...
                FR, masks, SI = pc.single_session(df_sess.iloc[i],deconv=False,
                                savefigs=True,fbase =fname,correct_only=True)
