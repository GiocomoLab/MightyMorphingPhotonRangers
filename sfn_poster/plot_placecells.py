...
if __name__ == '__main__':
    ...
    mice = ['4139190.1', '413919 0.3','4139212.2','4139212.4','4139219.2','4139219.3','4139224.2','4139224.3','4139224.5']
    ...
    for mouse in mice:
            ...
            for i in range(df_sess.shape[0]):
                try:
                    ...
                    FR, masks, SI = pc.single_session(df_sess.iloc[i],savefigs=True,fbase =fname)
