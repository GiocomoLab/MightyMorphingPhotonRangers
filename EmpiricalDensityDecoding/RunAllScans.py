...
if __name__ == '__main__':
    ...
    mice = ['4139265.3','4139265.4','4139265.5','4222153.2','4222154.1','4222153.1','4222153.3']
    mice = ['4139265.4','4139265.5','4222153.2','4222154.1','4222153.1','4222153.3']
    ...
    for mouse in mice:
        ...
        df_sess = df_mouse[df_mouse['Track'].str.match('TwoTower_noTimeout') | df_mouse['Track'].str.match('TwoTower_Timeout') | df_mouse['Track'].str.match('TwoTower_foraging')]
